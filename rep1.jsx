// ===========================================================================
// 1. CARROUSEL D'IMAGES (Ultra-rapide et sans erreur d'affichage)
// ===========================================================================
const ImageSlider = React.memo(({ images }) => {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '180px', backgroundColor: '#2a2a2a', borderRadius: '12px', overflow: 'hidden', userSelect: 'none' }} 
      ...
      {/* Si l'image est en erreur, on affiche une icône tracteur propre */}
...
function ChatWidget({ settings, isChatOpen, setIsChatOpen, chatMessages, setChatMessages, chatInput, setChatInput, isAiLoading, setIsAiLoading }) {
  const handleSendMessage = async () => {
    ...
    if (!settings.openAiApiKey) {
      setTimeout(() => {
        setChatMessages(prev => [...prev, { role: 'assistant', content: "🤖 Agent TractoRent : Configurez votre clé API OpenAI dans le panneau Admin." }]);
  ...
  return (
    <div style={{ position: 'fixed', bottom: '20px', right: '20px', zIndex: 999 }}>
      <div onClick={() => setIsChatOpen(!isChatOpen)} style={{ backgroundColor: settings.primaryColor, width: '65px', height: '65px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 8px 25px rgba(0,0,0,0.6)', transition: '0.3s' }}>
...
function App() {
  ...
  // --- DONNÉES DES TRACTEURS (4 PHOTOS OPTIMISÉES) ---
  ...
  return (
    <div style={{ backgroundColor: theme.bg, minHeight: '100vh', fontFamily: settings.fontFamily, color: '#fff', paddingBottom: '30px' }}>
      ...
      {/* =============================================
          EN-TÊTE PREMIUM - STYLE "TRUST MARKET"
          Logo à Gauche, Liens au Centre, Panier & Burger à Droite
         ============================================= */}
